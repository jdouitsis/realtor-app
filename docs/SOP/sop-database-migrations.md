...
| Command                                       | Purpose                                      |
| --------------------------------------------- | -------------------------------------------- |
| `pnpm --filter @finance/server db:generate`   | Generate migration from schema changes       |
| `pnpm --filter @finance/server db:migrate`    | Apply pending migrations to database         |
| `pnpm --filter @finance/server db:push`       | Push schema directly (dev only, no history)  |
| `pnpm --filter @finance/server db:studio`     | Open Drizzle Studio GUI                      |
...
Then generate migration: `pnpm --filter @finance/server db:generate`
