...
export { AppErrorCode } from '@app/shared/errors'
...
const APP_CODE_TO_TRPC: Record<AppErrorCode, TRPCError['code']> = {
  ...
  WAITLIST_USER: 'FORBIDDEN',
  OTP_EXPIRED: 'BAD_REQUEST',
  OTP_INVALID: 'BAD_REQUEST',
  OTP_MAX_ATTEMPTS: 'TOO_MANY_REQUESTS',
  REQUEST_NEW_OTP: 'FORBIDDEN',
  MAGIC_LINK_EXPIRED: 'BAD_REQUEST',
  MAGIC_LINK_USED: 'BAD_REQUEST',
  MAGIC_LINK_INVALID: 'NOT_FOUND',
  NOT_FOUND: 'NOT_FOUND',
